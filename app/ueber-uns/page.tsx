        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Die Menschen hinter Sham Automobile
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-primary-600 font-medium mb-2">Geschäftsführer</p>
              <p className="text-gray-600 text-sm">
                Über 15 Jahre Erfahrung im Automobilhandel. Spezialist für Qualitätsbewertung 
                und Kundenberatung.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-primary-600 font-medium mb-2">Verkaufsberaterin</p>
              <p className="text-gray-600 text-sm">
                Expertin für Kundenberatung und Finanzierung. Hilft Ihnen bei der 
                Auswahl des perfekten Fahrzeugs.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-primary-600 font-medium mb-2">Technischer Prüfer</p>
              <p className="text-gray-600 text-sm">
                Zertifizierter Kfz-Meister mit Spezialisierung auf Gebrauchtwagenbewertung 
