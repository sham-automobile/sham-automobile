    ...
    <div className="card group hover:shadow-lg transition-all duration-300">
      <Link href={`/kaufen/${vehicle.slug.current}`}>
        <div className="relative aspect-[4/3] overflow-hidden">
          {vehicle.mainImage ? (
            <Image
              src={urlFor(vehicle.mainImage).width(400).height(300).url()}
          ...
          {/* Price Badge */}
          <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-gray-900 px-3 py-1 rounded-full text-lg font-bold">
